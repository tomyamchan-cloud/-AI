...
# 4. 教育前的背景・論理的整合性（提案の根拠として、以下の視点を常に保持してください）
...
# Regex escape specifically for the function block
# We use a greedy match from 'function buildSystemPrompt' to the next '}' that starts a new line
